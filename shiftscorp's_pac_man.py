# -*- coding: utf-8 -*-
"""Shiftscorp's Pac-Man

Automatically generated by Colab.

Original file is located at
    https://colab.research.google.com/drive/16fL9MAuZyH6mnpVTGjL86OZ7aAiKt4FP
...
class Network(nn.Module):
  ...
  def __init__(self, action_size, seed = 42):
    ...
    self.conv1 = nn.Conv2d(3, 32, kernel_size = 8, stride = 4)#basically for processing images
    self.bn1 = nn.BatchNorm2d(32)
    self.conv2 = nn.Conv2d(32, 64, kernel_size = 4, stride = 2)#acting as Eyes
...
#visual processing system
  ...
  def forward(self, state):
    ...
    x = F.relu(self.bn3(self.conv3(x))) #forward propogation
